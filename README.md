[![Build Status](https://dev.azure.com/girwin/geofftest/_apis/build/status/geoff-marine.python-sample-vscode-flask-tutorial?branchName=master)](https://dev.azure.com/girwin/geofftest/_build/latest?definitionId=1&branchName=master)
